...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        private void colocarPecas()
        {
            ...
            colocarNovaPeca('a', 2, new xadrez.Peao(tab, Cor.Branca));
            colocarNovaPeca('b', 2, new xadrez.Peao(tab, Cor.Branca));
            colocarNovaPeca('c', 2, new xadrez.Peao(tab, Cor.Branca));
            colocarNovaPeca('d', 2, new xadrez.Peao(tab, Cor.Branca));
            colocarNovaPeca('e', 2, new xadrez.Peao(tab, Cor.Branca));
            colocarNovaPeca('f', 2, new xadrez.Peao(tab, Cor.Branca));
            colocarNovaPeca('g', 2, new xadrez.Peao(tab, Cor.Branca));
            colocarNovaPeca('h', 2, new xadrez.Peao(tab, Cor.Branca));
            ...
            colocarNovaPeca('a', 7, new xadrez.Peao(tab, Cor.Preta));
            colocarNovaPeca('b', 7, new xadrez.Peao(tab, Cor.Preta));
            colocarNovaPeca('c', 7, new xadrez.Peao(tab, Cor.Preta));
            colocarNovaPeca('d', 7, new xadrez.Peao(tab, Cor.Preta));
            colocarNovaPeca('e', 7, new xadrez.Peao(tab, Cor.Preta));
            colocarNovaPeca('f', 7, new xadrez.Peao(tab, Cor.Preta));
            colocarNovaPeca('g', 7, new xadrez.Peao(tab, Cor.Preta));
            colocarNovaPeca('h', 7, new xadrez.Peao(tab, Cor.Preta));
